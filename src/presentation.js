      ...
      >
        ...
        <Slide transition={['zoom']} bgColor='teal'>
          <Image
            width='100%'
            height='100%'
            src={images.jsFunction.replace('/', '')}
          />
          <Appear>
            <Image
              width='100%'
              height='100%'
              src={images.function.replace('/', '')}
            />
          </Appear>
        </Slide>
        <Slide transition={['zoom']} bgColor='teal'>
          <Image
            width='100%'
            height='100%'
            src={images.htmlFunction.replace('/', '')}
          />
        </Slide>
        <Slide transition={['zoom']} bgColor='blue'>
          <Heading
        ...
        <Slide transition={['fade']} bgColor='secondary' textColor='tertiary'>
          <Image
            width='75%'
            height='75%'
            src={images.architecture.replace('/', '')}
          />
        </Slide>
          ...
          <List textColor='primary' style={listStyle}>
            ...
            <Appear>
              <ListItem>
                <Link
                  textColor='primary'
                  href='https://github.com/avh4/elm-format'
                  target='_blank'
                >
                  Elm Format
                </Link>
            ...
            <Appear>
              <ListItem>
                <Link
                  textColor='primary'
                  href='http://package.elm-lang.org/'
                  target='_blank'
                >
                  Elm Packages
                </Link>
            ...
            <Appear>
              <ListItem>
                <Link
                  textColor='primary'
                  href='https://mbylstra.github.io/html-to-elm/'
                  target='_blank'
                >
                  HTML to Elm
                </Link>
            ...
            <Appear>
              <ListItem>
                <Link
                  textColor='primary'
                  href='http://noredink.github.io/json-to-elm/'
                  target='_blank'
                >
                  JSON to Elm
                </Link>
            ...
            <Appear>
              <ListItem>
                <Link
                  textColor='primary'
                  href='https://github.com/laurenmbeatty/osn-elm/tree/feature-enter-key'
                  target='_blank'
                >
                  GitHub repo
                </Link>
            ...
            <Appear>
              <ListItem>
                <Link
                  textColor='primary'
                  href='http://osn-elm-presentation.surge.sh/#/'
                  target='_blank'
                >
                  Slides
                </Link>
            ...
            <Appear>
              <ListItem>
                <Link
                  textColor='primary'
                  href='https://coggle.it/diagram/WohSPCGMFQABGL0_/t/elm'
                  target='_blank'
                >
                  Coggle
                </Link>
